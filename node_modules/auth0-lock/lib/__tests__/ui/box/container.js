...
describe('Container', function () {
  ...
  it('should submit the form when the submit button is not disabled', function () {
    var c = getContainer({ disableSubmitButton: false });
  ...
  it('should not submit the form when the submit button is disabled', function () {
    var c = getContainer({ disableSubmitButton: true });
    var connectionResolverMock = jest.fn();
    require('core/index').connectionResolver = function () {
      return connectionResolverMock;
    };

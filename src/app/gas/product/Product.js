...
import ProductDocument from "./tabs/ProductDocument";
...
function Product(props) {
  ...
  /**
   * Show Message if the requested Product is not exists
   */
  if (noProduct) {
    return (
      <motion.div
      ...
      <FusePageCarded
        ...
        contentToolbar={
          ...
          >
            ...
            {/* <Tab className="h-64" label="Product Document" /> */}{" "}
          </Tabs>
        }
        content={
...
export default withReducer("gas", reducer)(Product);
